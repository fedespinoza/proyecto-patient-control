...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@5.4.0/package.json"></script>
        ...
        <div class="row">
            <div class="col-12 nav-top">
                ...
                <div class="iconos">
                    <div class="calendario">
                        ...
                        <a href="{{ route('calendar.index') }}" class="topCalendario">Calendario</a>
                    </div>
                    <div class="agregar">
            ...
            <div class="col-3 menu-nav-aside">
                <nav>
                    ...
                    <a href="#" id="show" class="{{request()->routeIs('patient.create', 'patient.index', 'patient.show', 'patient.edit') ? 'current' : ''}}">PACIENTES</a>
                    ...
                    <a href="#" id="showOs" class="{{request()->routeIs('os.index', 'os.create', 'os.show', 'os.edit') ? 'current' : ''}}">OBRAS SOCIALES</a>
                    ...
                    <a href="{{ route('calendar.index') }}" class="{{request()->routeIs('calendar.index') ? 'current' : ''}}">CALENDARIO</a>
